...
public class EntityDeath implements Listener {
    ...
    private void populateEntityActions(YamlDocument config) {
        entityActions.put(EntityType.PLAYER, event -> {
            ...
            if ((config.getBoolean("PLAYER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("PLAYER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.BAT, event -> {
            if ((config.getBoolean("BAT.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("BAT.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.ENDER_DRAGON, event -> {
            if ((config.getBoolean("ENDER_DRAGON.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ENDER_DRAGON.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.ZOMBIE, event -> {
            if ((config.getBoolean("ZOMBIE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ZOMBIE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.WITHER_SKELETON, event -> {
            if ((config.getBoolean("WITHER_SKELETON.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("WITHER_SKELETON.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.CREEPER, event -> {
            if ((config.getBoolean("CREEPER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("CREEPER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.SKELETON, event -> {
            if ((config.getBoolean("SKELETON.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SKELETON.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.BLAZE, event -> {
            if ((config.getBoolean("BLAZE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("BLAZE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.SPIDER, event -> {
            if ((config.getBoolean("SPIDER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SPIDER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.CAVE_SPIDER, event -> {
            if ((config.getBoolean("CAVE_SPIDER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("CAVE_SPIDER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.CHICKEN, event -> {
            if ((config.getBoolean("CHICKEN.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("CHICKEN.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.COW, event -> {
            if ((config.getBoolean("COW.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("COW.Chance") + lootLvl) {

                //NamespacedKey timesFiredKey = new NamespacedKey(HeadDrop.getInstance(), "headHuntTotal");
                //int timesFired = event.getEntity().getKiller().getPersistentDataContainer().getOrDefault(timesFiredKey, PersistentDataType.INTEGER, 0);
                //event.getEntity().getKiller().getPersistentDataContainer().set(timesFiredKey, PersistentDataType.INTEGER, timesFired + 1);
        ...
        entityActions.put(EntityType.ENDERMAN, event -> {
            if ((config.getBoolean("ENDERMAN.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ENDERMAN.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.GIANT, event -> {
            if ((config.getBoolean("GIANT.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("GIANT.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.HORSE, event -> {
            if ((config.getBoolean("HORSE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("HORSE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.ILLUSIONER, event -> {
            if ((config.getBoolean("ILLUSIONER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ILLUSIONER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.IRON_GOLEM, event -> {
            if ((config.getBoolean("IRON_GOLEM.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("IRON_GOLEM.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.MAGMA_CUBE, event -> {
            if ((config.getBoolean("MAGMA_CUBE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("MAGMA_CUBE.Chance") + lootLvl) {
        ...
        try {
            entityActions.put(EntityType.MOOSHROOM, event -> {
                if ((config.getBoolean("MUSHROOM_COW.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("MUSHROOM_COW.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.OCELOT, event -> {
            if ((config.getBoolean("OCELOT.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("OCELOT.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.PIG, event -> {
            if ((config.getBoolean("PIG.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("PIG.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.SHEEP, event -> {
            if ((config.getBoolean("SHEEP.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SHEEP.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.SILVERFISH, event -> {
            if ((config.getBoolean("SILVERFISH.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SILVERFISH.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.SLIME, event -> {
            if ((config.getBoolean("SLIME.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SLIME.Chance") + lootLvl) {
        ...
        try {
            entityActions.put(EntityType.SNOW_GOLEM, event -> {
                if ((config.getBoolean("SNOW_GOLEM.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SNOW_GOLEM.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.SQUID, event -> {
            if ((config.getBoolean("SQUID.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SQUID.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.WITCH, event -> {
            if ((config.getBoolean("WITCH.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("WITCH.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.WITHER, event -> {
            if ((config.getBoolean("WITHER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("WITHER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.ZOMBIFIED_PIGLIN, event -> {
            if ((config.getBoolean("ZOMBIFIED_PIGLIN.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ZOMBIFIED_PIGLIN.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.GHAST, event -> {
            if ((config.getBoolean("GHAST.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("GHAST.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.WOLF, event -> {
            if ((config.getBoolean("WOLF.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("WOLF.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.VILLAGER, event -> {
            if ((config.getBoolean("VILLAGER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("VILLAGER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.RABBIT, event -> {
            if ((config.getBoolean("RABBIT.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("RABBIT.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.ENDERMITE, event -> {
            if ((config.getBoolean("ENDERMITE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ENDERMITE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.GUARDIAN, event -> {
            if ((config.getBoolean("GUARDIAN.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("GUARDIAN.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.SHULKER, event -> {
            if ((config.getBoolean("SHULKER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SHULKER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.POLAR_BEAR, event -> {
            if ((config.getBoolean("POLAR_BEAR.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("POLAR_BEAR.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.ZOMBIE_VILLAGER, event -> {
            if ((config.getBoolean("ZOMBIE_VILLAGER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ZOMBIE_VILLAGER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.VINDICATOR, event -> {
            if ((config.getBoolean("VINDICATOR.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("VINDICATOR.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.VEX, event -> {
            if ((config.getBoolean("VEX.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("VEX.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.EVOKER, event -> {
            if ((config.getBoolean("EVOKER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("EVOKER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.HUSK, event -> {
            if ((config.getBoolean("HUSK.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("HUSK.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.STRAY, event -> {
            if ((config.getBoolean("STRAY.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("STRAY.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.ELDER_GUARDIAN, event -> {
            if ((config.getBoolean("ELDER_GUARDIAN.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ELDER_GUARDIAN.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.DONKEY, event -> {
            if ((config.getBoolean("DONKEY.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("DONKEY.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.ZOMBIE_HORSE, event -> {
            if ((config.getBoolean("ZOMBIE_HORSE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ZOMBIE_HORSE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.SKELETON_HORSE, event -> {
            if ((config.getBoolean("SKELETON_HORSE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SKELETON_HORSE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.MULE, event -> {
            if ((config.getBoolean("MULE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("MULE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.PARROT, event -> {
            if ((config.getBoolean("PARROT.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("PARROT.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.TROPICAL_FISH, event -> {
            if ((config.getBoolean("TROPICAL_FISH.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("TROPICAL_FISH.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.PUFFERFISH, event -> {
            if ((config.getBoolean("PUFFERFISH.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("PUFFERFISH.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.SALMON, event -> {
            if ((config.getBoolean("SALMON.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SALMON.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.COD, event -> {
            if ((config.getBoolean("COD.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("COD.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.TURTLE, event -> {
            if ((config.getBoolean("TURTLE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("TURTLE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.DOLPHIN, event -> {
            if ((config.getBoolean("DOLPHIN.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("DOLPHIN.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.PHANTOM, event -> {
            if ((config.getBoolean("PHANTOM.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("PHANTOM.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.DROWNED, event -> {
            if ((config.getBoolean("DROWNED.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("DROWNED.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.WANDERING_TRADER, event -> {
            if ((config.getBoolean("WANDERING_TRADER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("WANDERING_TRADER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.TRADER_LLAMA, event -> {
            if ((config.getBoolean("TRADER_LLAMA.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("TRADER_LLAMA.Chance")) {
        ...
        entityActions.put(EntityType.LLAMA, event -> {
            if ((config.getBoolean("LLAMA.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("LLAMA.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.RAVAGER, event -> {
            if ((config.getBoolean("RAVAGER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("RAVAGER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.PILLAGER, event -> {
            if ((config.getBoolean("PILLAGER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("PILLAGER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.PANDA, event -> {
            if ((config.getBoolean("PANDA.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("PANDA.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.FOX, event -> {
            if ((config.getBoolean("FOX.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("FOX.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.CAT, event -> {
            if ((config.getBoolean("CAT.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("CAT.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.BEE, event -> {
            if ((config.getBoolean("BEE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("BEE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.ZOGLIN, event -> {
            if ((config.getBoolean("ZOGLIN.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ZOGLIN.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.STRIDER, event -> {
            if ((config.getBoolean("STRIDER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("STRIDER.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.PIGLIN, event -> {
            if ((config.getBoolean("PIGLIN.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("PIGLIN.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.HOGLIN, event -> {
            if ((config.getBoolean("HOGLIN.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("HOGLIN.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.PIGLIN_BRUTE, event -> {
            if ((config.getBoolean("PIGLIN_BRUTE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("PIGLIN_BRUTE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.GLOW_SQUID, event -> {
            if ((config.getBoolean("GLOW_SQUID.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("GLOW_SQUID.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.GOAT, event -> {
            if ((config.getBoolean("GOAT.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("GOAT.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.AXOLOTL, event -> {
            if ((config.getBoolean("AXOLOTL.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("AXOLOTL.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.ALLAY, event -> {
            if ((config.getBoolean("ALLAY.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ALLAY.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.FROG, event -> {
            if ((config.getBoolean("FROG.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("FROG.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.TADPOLE, event -> {
            if ((config.getBoolean("TADPOLE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("TADPOLE.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.WARDEN, event -> {
            if ((config.getBoolean("WARDEN.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("WARDEN.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.CAMEL, event -> {
            if ((config.getBoolean("CAMEL.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("CAMEL.Chance") + lootLvl) {
        ...
        entityActions.put(EntityType.SNIFFER, event -> {
            if ((config.getBoolean("SNIFFER.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("SNIFFER.Chance") + lootLvl) {
        ...
        try {
            entityActions.put(EntityType.ARMADILLO, event -> {
                if ((config.getBoolean("ARMADILLO.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("ARMADILLO.Chance") + lootLvl) {
            ...
            entityActions.put(EntityType.BREEZE, event -> {
                if ((config.getBoolean("BREEZE.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("BREEZE.Chance") + lootLvl) {
            ...
            entityActions.put(EntityType.BOGGED, event -> {
                if ((config.getBoolean("BOGGED.Drop")) && ThreadLocalRandom.current().nextFloat(0.01F, 100.0F) <= config.getFloat("BOGGED.Chance") + lootLvl) {
