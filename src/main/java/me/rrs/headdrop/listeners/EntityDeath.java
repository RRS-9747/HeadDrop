...
public class EntityDeath implements Listener {
    ...
    public void entityDropHeadEvent(final EntityDeathEvent event) {
        ...
        if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable")) && killerExist)  {
        ...
        if (type == EntityType.PLAYER) {
            if (Boolean.TRUE.equals(config.getBoolean("PLAYER.Require-Permission")) && entity.hasPermission("headdrop.player")){
                if (Boolean.TRUE.equals(config.getBoolean("PLAYER.Drop")) && x <= config.getInt("PLAYER.Chance") + lootLvl) {
                    ItemStack skull = SkullCreator.itemFromName(entity.getName());
                    event.getDrops().add(skull);
                    if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
                }
            }
        }else if (type == EntityType.BAT) {
            if (Boolean.TRUE.equals(config.getBoolean("BAT.Drop")) && x <= config.getInt("BAT.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("ZOMBIE.Drop")) && x <= config.getInt("ZOMBIE.Chance") + lootLvl) {
                event.getDrops().add(new ItemStack(Material.ZOMBIE_HEAD));

                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        }else if(type == EntityType.WITHER_SKELETON){
                if (Boolean.TRUE.equals(config.getBoolean("WITHER_SKELETON.Drop")) && x <= config.getInt("WITHER_SKELETON.Chance") + lootLvl) {
                    event.getDrops().add(new ItemStack(Material.WITHER_SKELETON_SKULL));

                    if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
                }
        }else if(type == EntityType.CREEPER){
            if (Boolean.TRUE.equals(config.getBoolean("CREEPER.Drop")) && x <= config.getInt("CREEPER.Chance") + lootLvl) {
                event.getDrops().add(new ItemStack(Material.CREEPER_HEAD));

                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        }else if(type == EntityType.SKELETON){
            if (Boolean.TRUE.equals(config.getBoolean("SKELETON.Drop")) && x <= config.getInt("SKELETON.Chance") + lootLvl) {
                event.getDrops().add(new ItemStack(Material.SKELETON_SKULL));

                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        }else if (type == EntityType.BLAZE) {
            if (Boolean.TRUE.equals(config.getBoolean("BLAZE.Drop")) && x <= config.getInt("BLAZE.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("SPIDER.Drop")) && x <= config.getInt("SPIDER.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("CAVE_SPIDER.Drop")) && x <= config.getInt("CAVE_SPIDER.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("CHICKEN.Drop")) && x <= config.getInt("CHICKEN.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("COW.Drop")) && x <= config.getInt("COW.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("ENDERMAN.Drop")) && x <= config.getInt("ENDERMAN.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("GIANT.Drop")) && x <= config.getInt("GIANT.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("HORSE.Drop")) && x <= config.getInt("HORSE.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("ILLUSIONER.Drop")) && x <= config.getInt("ILLUSIONER.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("IRON_GOLEM.Drop")) && x <= config.getInt("IRON_GOLEM.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("MAGMA_CUBE.Drop")) && x <= config.getInt("MAGMA_CUBE.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("MUSHROOM_COW.Drop")) && x <= config.getInt("MUSHROOM_COW.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("OCELOT.Drop")) && x <= config.getInt("OCELOT.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("PIG.Drop")) && x <= config.getInt("PIG.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("SHEEP.Drop")) && x <= config.getInt("SHEEP.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("SILVERFISH.Drop")) && x <= config.getInt("SILVERFISH.Chance") + lootLvl) {
                item = utils.rename(head.SILVERFISH, config.getString("SILVERFISH.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.SLIME) {
            if (Boolean.TRUE.equals(config.getBoolean("SLIME.Drop")) && x <= config.getInt("SLIME.Chance") + lootLvl) {
                item = utils.rename(head.SLIME, config.getString("SLIME.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.SNOWMAN) {
            if (Boolean.TRUE.equals(config.getBoolean("SNOW_GOLEM.Drop")) && x <= config.getInt("SNOW_GOLEM.Chance") + lootLvl) {
                item = utils.rename(head.SNOWMAN, config.getString("SNOW_GOLEM.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.SQUID) {
            if (Boolean.TRUE.equals(config.getBoolean("SQUID.Drop")) && x <= config.getInt("SQUID.Chance") + lootLvl) {
                item = utils.rename(head.SQUID, config.getString("SQUID.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.WITCH) {
            if (Boolean.TRUE.equals(config.getBoolean("WITCH.Drop")) && x <= config.getInt("WITCH.Chance") + lootLvl) {
                item = utils.rename(head.WITCH, config.getString("WITCH.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.WITHER) {
            if (Boolean.TRUE.equals(config.getBoolean("WITHER.Drop")) && x <= config.getInt("WITHER.Chance") + lootLvl) {
                item = utils.rename(head.WITHER, config.getString("WITHER.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.ZOMBIFIED_PIGLIN) {
            if (Boolean.TRUE.equals(config.getBoolean("ZOMBIFIED_PIGLIN.Drop")) && x <= config.getInt("ZOMBIFIED_PIGLIN.Chance") + lootLvl) {
                item = utils.rename(head.ZOMBIFIED_PIGLIN, config.getString("ZOMBIFIED_PIGLIN.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.GHAST) {
            if (Boolean.TRUE.equals(config.getBoolean("GHAST.Drop")) && x <= config.getInt("GHAST.Chance") + lootLvl) {
                item = utils.rename(head.GHAST, config.getString("GHAST.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.WOLF) {
            if (Boolean.TRUE.equals(config.getBoolean("WOLF.Drop")) && x <= config.getInt("WOLF.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("VILLAGER.Drop")) && x <= config.getInt("VILLAGER.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("RABBIT.Drop")) && x <= config.getInt("RABBIT.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("ENDERMITE.Drop")) && x <= config.getInt("ENDERMITE.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("GUARDIAN.Drop")) && x <= config.getInt("GUARDIAN.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("SHULKER.Drop")) && x <= config.getInt("SHULKER.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("POLAR_BEAR.Drop")) && x <= config.getInt("POLAR_BEAR.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("ZOMBIE_VILLAGER.Drop")) && x <= config.getInt("ZOMBIE_VILLAGER.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("VINDICATOR.Drop")) && x <= config.getInt("VINDICATOR.Chance") + lootLvl) {
                item = utils.rename(head.VINDICATOR, config.getString("VINDICATOR.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.VEX) {
            if (Boolean.TRUE.equals(config.getBoolean("VEX.Drop")) && x <= config.getInt("VEX.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("EVOKER.Drop")) && x <= config.getInt("EVOKER.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("HUSK.Drop")) && x <= config.getInt("HUSK.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("STRAY.Drop")) && x <= config.getInt("STRAY.Chance") + lootLvl) {
                item = utils.rename(head.STRAY, config.getString("STRAY.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.ELDER_GUARDIAN) {
            if (Boolean.TRUE.equals(config.getBoolean("ELDER_GUARDIAN.Drop")) && x <= config.getInt("ELDER_GUARDIAN.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("DONKEY.Drop")) && x <= config.getInt("DONKEY.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("ZOMBIE_HORSE.Drop")) && x <= config.getInt("ZOMBIE_HORSE.Chance") + lootLvl) {
                item = utils.rename(head.ZOMBIE_HORSE, config.getString("ZOMBIE_HORSE.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.SKELETON_HORSE) {
            if (Boolean.TRUE.equals(config.getBoolean("SKELETON_HORSE.Drop")) && x <= config.getInt("SKELETON_HORSE.Chance") + lootLvl) {
                item = utils.rename(head.SKELETON_HORSE, config.getString("SKELETON_HORSE.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.MULE) {
            if (Boolean.TRUE.equals(config.getBoolean("MULE.Drop")) && x <= config.getInt("MULE.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("PARROT.Drop")) && x <= config.getInt("PARROT.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("TROPICAL_FISH.Drop")) && x <= config.getInt("TROPICAL_FISH.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("PUFFERFISH.Drop")) && x <= config.getInt("PUFFERFISH.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("SALMON.Drop")) && x <= config.getInt("SALMON.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("COD.Drop")) && x <= config.getInt("COD.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("TURTLE.Drop")) && x <= config.getInt("TURTLE.Chance") + lootLvl) {
                item = utils.rename(head.TURTLE, config.getString("TURTLE.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.DOLPHIN) {
            if (Boolean.TRUE.equals(config.getBoolean("DOLPHIN.Drop")) && x <= config.getInt("DOLPHIN.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("PHANTOM.Drop")) && x <= config.getInt("PHANTOM.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("DROWNED.Drop")) && x <= config.getInt("DROWNED.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("WANDERING_TRADER.Drop")) && x <= config.getInt("WANDERING_TRADER.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("TRADER_LLAMA.Drop")) && x <= config.getInt("TRADER_LLAMA.Chance.Name")) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("LLAMA.Drop")) && x <= config.getInt("LLAMA.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("RAVAGER.Drop")) && x <= config.getInt("RAVAGER.Chance") + lootLvl) {
                item = utils.rename(head.RAVAGER, config.getString("RAVAGER.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.PILLAGER) {
            if (Boolean.TRUE.equals(config.getBoolean("PILLAGER.Drop")) && x <= config.getInt("PILLAGER.Chance") + lootLvl) {
                item = utils.rename(head.PILLAGER, config.getString("PILLAGER.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.PANDA) {
            if (Boolean.TRUE.equals(config.getBoolean("PANDA.Drop")) && x <= config.getInt("PANDA.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("FOX.Drop")) && x <= config.getInt("FOX.Chance") + lootLvl) {
                Fox fox = (Fox) entity;
            ...
            if (Boolean.TRUE.equals(config.getBoolean("CAT.Drop")) && x <= config.getInt("CAT.Chance") + lootLvl) {
                Cat cat = (Cat) entity;
            ...
            if (Boolean.TRUE.equals(config.getBoolean("BEE.Drop")) && x <= config.getInt("BEE.Chance") + lootLvl) {
                Bee bee = (Bee) entity;
                if (bee.getAnger() > 0) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("ZOGLIN.Drop")) && x <= config.getInt("ZOGLIN.Chance") + lootLvl) {
                item = utils.rename(head.ZOGLIN, config.getString("ZOGLIN.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.STRIDER) {
            if (Boolean.TRUE.equals(config.getBoolean("STRIDER.Drop")) && x <= config.getInt("STRIDER.Chance") + lootLvl) {
                item = utils.rename(head.STRIDER, config.getString("STRIDER.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.PIGLIN) {
            if (Boolean.TRUE.equals(config.getBoolean("PIGLIN.Drop")) && x <= config.getInt("PIGLIN.Chance") + lootLvl) {
                item = utils.rename(head.PIGLIN, config.getString("PIGLIN.Name"));
                event.getDrops().add(item);
                if (Boolean.TRUE.equals(config.getBoolean("Bot.Enable"))) embed.msg(title, description, footer);
            }
        } else if (type == EntityType.HOGLIN) {
            if (Boolean.TRUE.equals(config.getBoolean("HOGLIN.Drop")) && x <= config.getInt("HOGLIN.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("PIGLIN_BRUTE.Drop")) && x <= config.getInt("PIGLIN_BRUTE.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("GLOW_SQUID.Drop")) && x <= config.getInt("GLOW_SQUID.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("GOAT.Drop")) && x <= config.getInt("GOAT.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("AXOLOTL.Drop")) && x <= config.getInt("AXOLOTL.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("ALLAY.Drop")) && x <= config.getInt("ALLAY.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("FROG.Drop")) && x <= config.getInt("FROG.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("TADPOLE.Drop")) && x <= config.getInt("TADPOLE.Chance") + lootLvl) {
            ...
            if (Boolean.TRUE.equals(config.getBoolean("WARDEN.Drop")) && x <= config.getInt("WARDEN.Chance") + lootLvl) {
